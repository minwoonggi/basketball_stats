...
class BsUser(models.Model):
    user_id = models.CharField(max_length=32, verbose_name='아이디', primary_key=True)
    password = models.CharField(max_length=128, verbose_name='비밀번호')
    user_name = models.CharField(max_length=32, verbose_name='이름')
    team_name = models.ForeignKey('BsTeam', on_delete=models.CASCADE, db_column='team_name',max_length=32, verbose_name='팀명')
...
class BsTeam(models.Model):
    team_name = models.CharField(max_length=32, verbose_name='팀명', primary_key=True)
